...
describe('one commercial catalogue', () => {
  ...
  test.each([[{ price: { id: 'price_external' }, quantity: 1 }], [{ price: { id: 'price_growth' }, quantity: 2 }], [{ price: { id: 'price_growth' }, quantity: 1 }, { price: { id: 'price_basicScreen' }, quantity: 1 }]])('rejects unknown and mismatched subscription items', items => expect(() => subscriptionAllowance(catalogue, items)).toThrow());
});
