...
export const OrganizationView = () => {
  ...
  useEffect(() => {
    ...
    if (ownerId === user.uid || userProfile?.platformRole === 'admin') { setAllowed(true); return; }
  ...
  }, [user, orgId, ownerId, userProfile?.platformRole]);
