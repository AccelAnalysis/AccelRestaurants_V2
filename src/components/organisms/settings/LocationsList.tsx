...
import { MapPin, Plus, Edit2, Trash2, Globe, Search, Loader, Layers } from 'lucide-react';
      ...
      <div className="flex-1 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredLocations.map((location) => (
            <div key={location.id} className="bg-surface border border-surface-highlight rounded-lg p-4 shadow-sm hover:border-primary/30 transition-colors group relative">
