...
export const WebsiteContentEditor = () => {
  ...
  return <section className="rounded-xl border border-surface-highlight p-5 sm:p-6 space-y-5"><h3 className="text-xl font-semibold">Website content</h3><p className="text-text-secondary">Benefits and guest feedback appear on the homepage. Common questions appear on the Plans page. Save each section to publish your changes.</p><InlineFeedback tone="error" message={error} /><InlineFeedback tone="success" message={saved ? 'Website content saved.' : null} /><form onSubmit={save} className="space-y-6">
